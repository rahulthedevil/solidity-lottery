...
contract Lottery is Ownable {
    ...
    mapping (uint => mapping (address => bool)) internal playerAddresses;
    ...
    function playLottery1() public {
        ...
        // gameStatus is false.
        if ((playerAddresses[currentMappingVersion][msg.sender]) || (!gameStatus)) {
            revert();
        }
        ...
        playerAddresses[currentMappingVersion][msg.sender] = true;
    ...
    function getWinner() internal {
        ...
        IERC20(0xA3f742E790ce255CfEf42282A0dA123d3A99436F).transfer(address(winnerAddress), winningAmount.div(100).mul(98));
        IERC20(0xA3f742E790ce255CfEf42282A0dA123d3A99436F).transfer(address(creator), winningAmount.div(100).mul(2));
    }
